...
class MainTests(unittest.TestCase):
    ...
    def test_create_author(self):
        ...
        post_data = {
            'name': 'super author',
            'biography': 'author is very super duper'
        }
        self.app.post('/create_author', data=post_data)

        # Verify that the author was updated in the database
        created_author = Author.query.filter_by(name='super author').one()
        self.assertIsNotNone(created_author)
        self.assertEqual(created_author.name, 'super author')
        self.assertEqual(created_author.biography, 'author is very super duper')
    ...
    def test_create_genre(self):
        ...
        created_genre = Genre.query.filter_by(name='pretty good').one()
        self.assertIsNotNone(created_genre)
        self.assertEqual(created_genre.name, 'pretty good')
